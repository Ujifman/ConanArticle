...
- `build_requires` - стандартное поле Conan со списоком зависимостей, необходимых для сборки библиотеки
- `requires` - стандартное поле Conan со списоком зависимостей, необходимых для работы библиотеки
