...
- `build_requires` - стандартное поле Conan со списокм зависимостей, необходимых для сборки библиотеки
- `requires` - стандартное поле Conan со списокм зависимостей, необходимых для работы библиотеки
